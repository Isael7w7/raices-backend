...
describe('InstitutionsController', () => {
  ...
  describe('findMine', () => {
    it('should return user institution', async () => {
      ...
      const result = await controller.findMine({ id: 'user1', email: 'user1@test.com', rol: 'pcd', nombreCompleto: 'User 1', verificado: false })
  ...
  describe('create', () => {
    it('should create institution with dto and user', async () => {
      ...
      const result = await controller.create(dto as any, { id: 'user1', email: 'user1@test.com', rol: 'institucion', nombreCompleto: 'User 1', verificado: false })
  ...
  describe('updateMine', () => {
    it('should update user institution', async () => {
      ...
      const result = await controller.updateMine({ id: 'user1', email: 'user1@test.com', rol: 'institucion', nombreCompleto: 'User 1', verificado: false }, dto as any)
  ...
  describe('update', () => {
    it('should update institution by id with user context', async () => {
      ...
      const result = await controller.update('inst-1', dto as any, { id: 'user1', email: 'user1@test.com', rol: 'institucion', nombreCompleto: 'User 1', verificado: false })
  ...
  describe('remove', () => {
    it('should remove institution by id with user context', async () => {
      ...
      const result = await controller.remove('inst-1', { id: 'user1', email: 'user1@test.com', rol: 'admin', nombreCompleto: 'User 1', verificado: false })
